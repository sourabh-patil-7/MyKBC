...
public class Simple {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // database is KBC
        Connection connect = DriverManager.getConnection("Jdbc:mysql://localhost:3306/kbc", "root", "root123" +
                "");
        ...
        while (true) {
            try {
                ...
                if (enter == 1) {
                    ...
                    age = m.nextInt();
                    int rs = statement
                            .executeUpdate("insert into score(name,age) values('" + sname + "'," + age + ");");
                    int sc = statement.executeUpdate(
                            "update score set score=0 where name like '" + sname + "' && age=" + age + ";");
                    ...
                    if (age < 100) {
                        ...
                        move: {
                            ...
                            if (change % 2 == 0) {
                                ...
                                System.out.println("\t\t\t\t\t\t|1 . your Question for Rs 5000 is |");
                                System.out.println(
                                        "Which of the following name means “Person of long age “?                               \t\t|-----------Lifeline------------|");
                                System.out.println(
                                        "(A) Abhitabh                  (B) Arunodaya                                           \t\t| Type lifeline                 |");
                                System.out.println(
                                        "                                                                                      \t\t|-------------------------------|");
                            ...
                            switch (sss) {
                                ...
                                case "lifeline":
                                    ...
                                    if (timer > 31000) {
                                        System.out
                                                .println("Sorry you are too late. You have 30 Seconds to give answer");
                                        return;
                                    }
                                    switch (sss) {
                                        case "d":
                        ...
                        move1: {
                            ...
                            if (change % 2 == 1) {
                                ...
                                System.out.println(
                                        "How is the call of a chicken usually expressed?                                       \t\t|-----------Lifeline------------|");
                                System.out.println(
                                        "(A) Denchu Dencu             (B) Kukro Koo                                            \t\t|Type lifeline\t\t\t|");
                                System.out.println(
                                        "                                                                                      \t\t|-------------------------------|");
                        ...
                        move3: {
                            ...
                            switch (sss) {
                                case "b":
                                case "B":
                                    int sc1 = statement.executeUpdate("update score set score=80000 where name like '"
                                            + sname + "' && age=" + age + ";");
                                ...
                                case "lifeline":
                                    ...
                                    switch (sss) {
                                        ...
                                        case "B":
                                            ...
                                            sc1 = statement
                                                    .executeUpdate("update score set score=40000 where name like '"
                                                            + sname + "' && age=" + age + ";");
                                            System.out.println("yes you are right you won Rs.40,000");
                                            Thread.sleep(1600);
                                            System.out.println("\nYour next question for Rs.80,000");
                                        ...
                                        case "lifeline":
                                            ...
                                            switch (sss) {
                                                ...
                                                case "B":
                                                    sc1 = statement
                                                            .executeUpdate(
                                                                    "update score set score=40000 where name like '"
                                                                            + sname + "' && age=" + age + ";");
                                                    System.out.println("yes you are right you won Rs.40,000");
                                                    Thread.sleep(1600);
                                                    System.out.println("\nYour next question for Rs.80,000");
                        ...
                        move4: {
                            ...
                            if (change % 2 == 1) {
                                ...
                                System.out.println(
                                        "                                                                                                  \t\t|-------------------------------|");
                                System.out
                                        .println("(C) Namkeen Ho Jaati Hai                    (D) Haseen Ho Jaati Hai");
                            ...
                            switch (sss) {
                                case "d":
                                case "D":
                                    int sc2 = statement.executeUpdate("update score set score=640000 where name like '"
                                            + sname + "' && age=" + age + ";");
                                ...
                                case "lifeline":
                                    ...
                                    switch (sss) {
                                        ...
                                        case "D":
                                            sc2 = statement
                                                    .executeUpdate("update score set score=640000 where name like '"
                                                            + sname + "' && age=" + age + ";");
                                            System.out.println("yes you are right you won Rs.6,40,000");
                                            Thread.sleep(1600);
                                            System.out.println("\nYour next question for Rs.12,50,000");
                                        ...
                                        case "lifeline":
                                            ...
                                            switch (sss) {
                                                ...
                                                case "D":
                                                    sc2 = statement
                                                            .executeUpdate(
                                                                    "update score set score=640000 where name like '"
                                                                            + sname + "' && age=" + age + ";");
                                                    System.out.println("yes you are right you won Rs.6,40,000");
                                                    Thread.sleep(1600);
                                                    System.out.println("\nYour next question for Rs.12,50,000");
                                    ...
                                    switch (sss) {
                                        ...
                                        case "lifeline":
                                            ...
                                            switch (sss) {
                                                ...
                                                default:
                                                    System.out
                                                            .println("You are wrong today you won Only Rs.6,40,000/-");
                                                    return;
                                            }
                                        default:
                        ...
                        move4: {
                            ...
                            switch (sss) {
                                ...
                                case "A":
                                    int sc4 = statement
                                            .executeUpdate("update score set score=10000000 where name like '"
                                                    + sname + "' && age=" + age + ";");
                                    ...
                                    for (int win = 1; win <= 4; win++) {
                                        ...
                                        // printing the winner logo
                                        WinnerLogo1 winner = new WinnerLogo1();
                                        winner.WinnerLogo();
                                            ...
                                            switch (sss) {
                                                ...
                                                case "A":
                                                    sc4 = statement.executeUpdate(
                                                            "update score set score=10000000 where name like '" + sname
                                                                    + "' && age=" + age + ";");
                                                    System.out.println("yes you are right you won Rs.1 Crore\n");
                                                    Thread.sleep(2000);
                                                    for (int asd = 1; asd <= 100; asd++) {
                    ...
                    // Connection conn;
                    // String strSelect = "select * from score where name = " + yourname + " && age=
                    // " + yourage + ";";
                    // PreparedStatement st = conn.prepareStatement(strSelect);
                    // st.setString(1,name);

                    ResultSet Res = statement.executeQuery(
                            "select * from score where name = " + yourname2 + " && age= " + yourage + ";");
                    // ResultSet Res = statement.executeQuery("select * from score where name =
                    // 'WINNER'");
                    System.out.println(
                            "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                    while (Res.next()) {
                ...
                // Help OPTION
                    ...
                    // printing the help options
                    Help help = new Help();
                    help.printHelpDescription();

                    System.out.println("If you understand the rules then type ok");
                    Scanner ok = new Scanner(System.in);
                    String check = ok.nextLine();
                    check.toLowerCase();
                    if (check == "ok")
                        continue;
                    else
    ...
    public void lifeline(int option_number) {
        Scanner m = new Scanner(System.in);
        if (option_number == 1) {
            try {
                System.out.print("------------------------------------------------------");
